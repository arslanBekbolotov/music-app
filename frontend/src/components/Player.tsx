...
import {FastForwardRounded, FastRewindRounded, VolumeDownRounded, VolumeUpRounded} from "@mui/icons-material";
...
const MusicPlayer = () => {
  ...
  return (
      <Box sx={{ width: '100%', overflow: 'hidden',display: `${!currentPlayingTrack ? 'none' : 'block'}`, }}>
        <Widget>
